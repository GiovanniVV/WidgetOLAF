...
<button id="chat-button" aria-label="Abrir chat">
  <img src="https://scontent.floh2-1.fna.fbcdn.net/v/t39.30808-6/482126094_122113539728778866_6476881881439247934_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=127cfc&_nc_ohc=lzqaWVtcl_IQ7kNvgFstHP9&_nc_oc=AdgN1GyHd4OwnHaz8cELMdGvd8bi5CEoDO-Hi1_GPk2FgYybcDum9-ruZ7Ytf2igKpE&_nc_zt=23&_nc_ht=scontent.floh2-1.fna&_nc_gid=AXwjGHPT1Qg8GRvEEW_mtQ-&oh=00_AYHQ5tTNksttwMfU6_Nl_F3eF2c9IHopxqfZfqt-oqJ8NA&oe=67D297CB">
</button>
...
<div id="chat-widget" aria-live="polite">
  <div id="chat-header">
      <div id="header-content">
        <img src="https://scontent.floh2-1.fna.fbcdn.net/v/t39.30808-6/482126094_122113539728778866_6476881881439247934_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=127cfc&_nc_ohc=lzqaWVtcl_IQ7kNvgFstHP9&_nc_oc=AdgN1GyHd4OwnHaz8cELMdGvd8bi5CEoDO-Hi1_GPk2FgYybcDum9-ruZ7Ytf2igKpE&_nc_zt=23&_nc_ht=scontent.floh2-1.fna&_nc_gid=AXwjGHPT1Qg8GRvEEW_mtQ-&oh=00_AYHQ5tTNksttwMfU6_Nl_F3eF2c9IHopxqfZfqt-oqJ8NA&oe=67D297CB" class="avatar" alt="Avatar de chat">
...
`;
  ...
  function sendMessage(message) {
    ...
    fetch(`http://127.0.0.1:8000/generar_respuesta/${encodeURIComponent(message)}/`, {
      method: "GET",
      credentials: "include" // Esto hace que se envíen cookies de sesión automáticamente
    })
      .then(response => response.json())
      .then(data => console.log("Datos del chat:", data))
