...
<div id="chat-widget" aria-live="polite">
  ...
  <div id="welcome-message" class="welcome-message">
    <h1 class="mensajeBienvenida"><strong>Bienvenido a tu asistente de búsqueda Chatbanker</strong></h1>
...
`;
  ...
  async function sendMessage(message) {
    // Oculta el mensaje de bienvenida si es el primer mensaje
    if (!firstMessageSent) {
    ...
    // Limpia el campo de entrada y vuelve a establecer el foco
