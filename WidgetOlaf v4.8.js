(function () {
  ...
  :root {
        ...
        --user-messager-background: #8D6EFF;
      }
      ...
      .user-message {
        background-color: var(--user-messager-background);
        color: white;
        text-align: right;
        align-self: flex-end;
        /* Alinea a la derecha */
  ...
  <button id="chat-button" aria-label="Abrir chat">
    <img src="https://scontent.floh3-1.fna.fbcdn.net/v/t39.30808-6/482126094_122113539728778866_6476881881439247934_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeFXVyCSK4VIRK17XR-p_o5x1_N1Yq-DaQbX83Vir4NpBjjUWJBr94ZgRlP_o7WJ0Vg639YJoBqrLpvaCXxwnvxC&_nc_ohc=VLi7ZfUeU6oQ7kNvwHmvKmc&_nc_oc=Adl-ypZSgwjmM8IwmsSri-r2ejWkE4biGoNKICWttAw-9vkQLZzPw4SXItHISK85PmA&_nc_zt=23&_nc_ht=scontent.floh3-1.fna&_nc_gid=KT8XrsyRDQ1zOUnTygQnwg&oh=00_AfEnMiiqWuIR_GuEKZT7fMHGknvt7aIj9_BXaRD022NehA&oe=680AD7CB">
  </button>
  ...
  <div id="chat-widget" aria-live="polite">
    <div id="chat-header">
        <div id="header-content">
          <img src="https://scontent.floh3-1.fna.fbcdn.net/v/t39.30808-6/482126094_122113539728778866_6476881881439247934_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeFXVyCSK4VIRK17XR-p_o5x1_N1Yq-DaQbX83Vir4NpBjjUWJBr94ZgRlP_o7WJ0Vg639YJoBqrLpvaCXxwnvxC&_nc_ohc=VLi7ZfUeU6oQ7kNvwHmvKmc&_nc_oc=Adl-ypZSgwjmM8IwmsSri-r2ejWkE4biGoNKICWttAw-9vkQLZzPw4SXItHISK85PmA&_nc_zt=23&_nc_ht=scontent.floh3-1.fna&_nc_gid=KT8XrsyRDQ1zOUnTygQnwg&oh=00_AfEnMiiqWuIR_GuEKZT7fMHGknvt7aIj9_BXaRD022NehA&oe=680AD7CB" class="avatar" alt="Avatar de chat">
    ...
    <div id="welcome-message" class="welcome-message">
        <h3 class="mensajeBienvenida"><strong>😊 ¡Hola! Soy Sofdino, tu compañero de búsqueda 🤖</strong></h3>
