(function () {
  ...
  :root {
    ...
    --bot-bubble-bg: rgba(242, 242, 242, 0.95);
    --user-bubble-bg: linear-gradient(135deg, var(--chat-primary), var(--chat-secondary));
  }
  ...
  #chat-button-modern {
    ...
    border: none;
    cursor: pointer;
    box-shadow: 0 8px 32px rgba(215, 109, 56, 0.4);
    display: flex;
    align-items: center;
  ...
  #chat-button-modern:hover {
    ...
    box-shadow: 0 12px 40px rgba(215, 109, 56, 0.6);
  }

  #chat-button-modern:hover::before {
    opacity: 1;
  }
  ...
  <button id="chat-button-modern" aria-label="Abrir chat">
    <img src="https://media.discordapp.net/attachments/959629036538171424/1451411657086603274/Gemini_Generated_Image_3mscqo3mscqo3msc.png" alt="Chat avatar">
  ...
  <div id="chat-widget-modern">
    ...
    <div id="chat-header-modern">
      <div class="chat-avatar-wrapper">
        <img src="https://media.discordapp.net/attachments/959629036538171424/1451411657086603274/Gemini_Generated_Image_3mscqo3mscqo3msc.png" alt="Sofdino Avatar" class="chat-avatar-modern">
    ...
    <div id="chat-body-modern">
      <div class="welcome-message-modern" id="welcome-message-modern">
        ...
        <div class="quick-questions">
          <button class="quick-question-btn" data-question="¿Qué servicios ofrecen?">
            💼 ¿Qué servicios ofrecen?
          </button>
          <button class="quick-question-btn" data-question="¿Cuánto cuesta un proyecto?">
            💰 ¿Cuánto cuesta un proyecto?
          </button>
          <button class="quick-question-btn" data-question="¿Cómo puedo contactarlos?">
    ...
    <div class="chat-input-container">
      ...
      <div class="chat-footer-branding">Powered by Sofmu AI</div>
    </div>
  </div>
  `;
