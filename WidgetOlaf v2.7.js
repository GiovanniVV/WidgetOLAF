...
:root {
    ...
    #welcome-message {
        background-color: #C8A2C8; /* Fondo lila */
        width: 95%;              /* Ocupa el 95% del ancho */
        margin: 20px auto;       /* Centrado horizontal con margen automático y un margen superior/inferior */
...
<div id="chat-widget" aria-live="polite">
  ...
  <div id="welcome-message" class="welcome-message">
      <h2 class="mensajeBienvenida"><strong>Bienvenido a tu asistente de búsqueda SofDino</strong></h1>
