...
#chat-button img {
  ...
  border-radius: 50%;
  object-fit: cover;
  pointer-events: none; /* Evita que la imagen reciba el enfoque */
}

#chat-button:focus-visible {
  outline: none !important; /* Forza la eliminación del contorno en navegadores que usan :focus-visible */
}

#chat-button::-moz-focus-inner {
  border: 0 !important; /* Elimina bordes internos específicos de Firefox */
}

#chat-button:focus:not(:focus-visible) {
  outline: none !important; /* Asegura que se elimine el borde en navegadores con focus no visible */
}
...
#chat-controls {
  ...
  display: flex;
  flex-direction: row;
  height: 67%; /* Asegúrate de que el contenedor ocupa la altura total */
  gap: 0px;
}
...
#chat-controls button {
  ...
  height: 40px; /* Ajusta el tamaño del botón si es necesario */
  display: flex;
  align-items: center;
  justify-content: center;
}
...
#chat-controls button:active {
    outline: none;
    box-shadow: none; /* Elimina sombras o bordes adicionales */
}
...
.message {
  padding: 0px 10px; /* Ajusta el padding para que no quede demasiado espacio */
  border-radius: 8px;
  max-width: 80%; 
...
<button id="chat-button" aria-label="Abrir chat">
  <img src="http://127.0.0.1:8000/static/OLAFv2.jpeg" alt="Icono de chat">
</button>
...
<div id="chat-widget" aria-live="polite">
  <div id="chat-header">
      <div id="header-content">
          <img src="http://127.0.0.1:8000/static/OLAFv2.jpeg" class="avatar" alt="Avatar de chat">
